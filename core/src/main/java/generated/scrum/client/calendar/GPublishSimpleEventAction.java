...
package generated.scrum.client.calendar;

import java.util.*;

public abstract class GPublishSimpleEventAction
            extends scrum.client.common.AScrumAction {

    protected scrum.client.calendar.SimpleEvent simpleEvent;

    public GPublishSimpleEventAction(scrum.client.calendar.SimpleEvent simpleEvent) {
