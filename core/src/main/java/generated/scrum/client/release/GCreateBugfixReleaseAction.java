...
package generated.scrum.client.release;

import java.util.*;

public abstract class GCreateBugfixReleaseAction
            extends scrum.client.common.AScrumAction {

    protected scrum.client.release.Release release;

    public GCreateBugfixReleaseAction(scrum.client.release.Release release) {
