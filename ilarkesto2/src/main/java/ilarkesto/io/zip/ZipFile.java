...
public class ZipFile implements ZipConstants {
        ...
        // File from which zip entries_local are read.
        private final RandomAccessFile raf;
        // The entries_local of this zip file when initialized and not yet closed.
        ...
        /**
         * Read an unsigned short in little endian byte order from the given DataInput stream using the given byte
         * buffer.
         *
        ...
        private void readEntries() throws ZipException, IOException {
                /*
                 * Search for the End Of Central Directory. When a zip comment is present the directory may start
                 * earlier. FIXME: This searches the whole file in a very slow manner if the file isn't a zip file.
                 */
                ...
                for (int i = 0; i < count; i++) {
                        ...
                        String name_local = new String(buffer, 0, 0, nameLen);

                        ZipEntry entry = new ZipEntry(name_local);
        ...
        /**
         * Checks that the ZipFile is still open and reads entries_local when necessary.
         *
         * @exception IllegalStateException when the ZipFile has already been closed.
         * @exception IOEexception when the entries_local could not be read.
         */
        ...
        /**
         * Searches for a zip entry in this archive with the given name_local.
         *
        ...
        /**
         * Checks, if the local header of the entry at index i matches the central directory, and returns the offset to
         * the data.
         *
         ...
         *
         * @exception IOException if a i/o error occured.
         * @exception ZipException if the local header doesn't match the central directory header
         */
        ...
        /**
         * Creates an input stream reading the given zip entry as uncompressed data. Normally zip entry should be an
         * entry returned by getEntry() or entries_local().
         *
        ...
        public InputStream getInputStream(ZipEntry entry) throws IOException {
                HashMap entries_local = getEntries();
                String name_local = entry.getName();
                ZipEntry zipEntry = (ZipEntry) entries_local.get(name_local);
                if (zipEntry == null) {
                        throw new NoSuchElementException(name_local);
                }
