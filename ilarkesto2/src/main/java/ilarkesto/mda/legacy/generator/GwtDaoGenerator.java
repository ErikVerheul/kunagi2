...
public class GwtDaoGenerator extends AClassGenerator {
    ...
    protected Set<String> getStaticImports() {
        ...
        ret.add("ilarkesto.core.base.Utl.equalObjects");
        ret.add("ilarkesto.core.logging.ClientLog.*");
        return ret;
    }
    ...
    protected void writeContent() {
        for (EntityModel entity : entities) {
            ...
            ln("    }");
            ln();
            ln("    protected " + type + " update" + name + "(Map<String, Object> data) {");
        ...
        ln();
        ln("    @Override");
        ln("    protected final " + AGwtEntity.class.getName() + " updateLocalEntity(String type, Map<String, Object> data) {");
        for (EntityModel entity : entities) {
