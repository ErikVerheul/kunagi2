...
public abstract class Persist {
	...
	public static List<HashMap<String, Object>> createPropertiesMaps(Collection<? extends AEntity> entities) {
		List<HashMap<String, Object>> result = new ArrayList<>(entities.size());
