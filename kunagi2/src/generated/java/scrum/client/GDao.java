...
public abstract class GDao
    ...
    protected scrum.client.pr.BlogEntry updateBlogEntry(KunagiProperties data) {
        ...
        if (entity == null) {
            ...
            DEBUG("BlogEntry received: " + entity.getId() + " ("+entity+")");
        } else {
            entity.updateProperties(data);
            DEBUG("BlogEntry updated: " + entity);
        }
        return entity;
    }
    ...
    protected scrum.client.journal.Change updateChange(KunagiProperties data) {
        ...
        if (entity == null) {
            ...
            DEBUG("Change received: " + entity.getId() + " ("+entity+")");
        } else {
            entity.updateProperties(data);
            DEBUG("Change updated: " + entity);
        }
        return entity;
    }
    ...
    protected scrum.client.collaboration.ChatMessage updateChatMessage(KunagiProperties data) {
        ...
        if (entity == null) {
            ...
            DEBUG("ChatMessage received: " + entity.getId() + " ("+entity+")");
        } else {
            entity.updateProperties(data);
            DEBUG("ChatMessage updated: " + entity);
        }
        return entity;
    }
    ...
    protected scrum.client.collaboration.Comment updateComment(KunagiProperties data) {
        ...
        if (entity == null) {
            ...
            DEBUG("Comment received: " + entity.getId() + " ("+entity+")");
        } else {
            entity.updateProperties(data);
            DEBUG("Comment updated: " + entity);
        }
        return entity;
    }
    ...
    protected scrum.client.collaboration.Emoticon updateEmoticon(KunagiProperties data) {
        ...
        if (entity == null) {
            ...
            DEBUG("Emoticon received: " + entity.getId() + " ("+entity+")");
        } else {
            entity.updateProperties(data);
            DEBUG("Emoticon updated: " + entity);
        }
        return entity;
    }
    ...
    protected scrum.client.files.File updateFile(KunagiProperties data) {
        ...
        if (entity == null) {
            ...
            files.put(id, entity);
            DEBUG("File received: " + entity.getId() + " ("+entity+")");
        } else {
            entity.updateProperties(data);
            DEBUG("File updated: " + entity);
        }
        return entity;
    }
    ...
    protected scrum.client.impediments.Impediment updateImpediment(KunagiProperties data) {
        ...
        if (entity == null) {
            ...
            DEBUG("Impediment received: " + entity.getId() + " ("+entity+")");
        } else {
            entity.updateProperties(data);
            DEBUG("Impediment updated: " + entity);
        }
        return entity;
    }
    ...
    protected scrum.client.issues.Issue updateIssue(KunagiProperties data) {
        ...
        if (entity == null) {
            ...
            DEBUG("Issue received: " + entity.getId() + " ("+entity+")");
        } else {
            entity.updateProperties(data);
            DEBUG("Issue updated: " + entity);
        }
        return entity;
    }
    ...
    protected scrum.client.project.Project updateProject(KunagiProperties data) {
        ...
        if (entity == null) {
            ...
            DEBUG("Project received: " + entity.getId() + " ("+entity+")");
        } else {
            entity.updateProperties(data);
            DEBUG("Project updated: " + entity);
        }
        return entity;
    }
    ...
    protected scrum.client.journal.ProjectEvent updateProjectEvent(KunagiProperties data) {
        ...
        if (entity == null) {
            ...
            DEBUG("ProjectEvent received: " + entity.getId() + " ("+entity+")");
        } else {
            entity.updateProperties(data);
            DEBUG("ProjectEvent updated: " + entity);
        }
        return entity;
    }
    ...
    public final void clearProjectUserConfigs() {
        DEBUG("Clearing ProjectUserConfigs");
    ...
    protected scrum.client.admin.ProjectUserConfig updateProjectUserConfig(KunagiProperties data) {
        ...
        if (entity == null) {
            ...
            DEBUG("ProjectUserConfig received: " + entity.getId() + " ("+entity+")");
        } else {
            entity.updateProperties(data);
            DEBUG("ProjectUserConfig updated: " + entity);
        }
        return entity;
    }
    ...
    protected scrum.client.project.Quality updateQuality(KunagiProperties data) {
        ...
        if (entity == null) {
            ...
            DEBUG("Quality received: " + entity.getId() + " ("+entity+")");
        } else {
            entity.updateProperties(data);
            DEBUG("Quality updated: " + entity);
        }
        return entity;
    }
    ...
    protected scrum.client.release.Release updateRelease(KunagiProperties data) {
        ...
        if (entity == null) {
            ...
            DEBUG("Release received: " + entity.getId() + " ("+entity+")");
        } else {
            entity.updateProperties(data);
            DEBUG("Release updated: " + entity);
        }
        return entity;
    }
    ...
    protected scrum.client.project.Requirement updateRequirement(KunagiProperties data) {
        ...
        if (entity == null) {
            ...
            DEBUG("Requirement received: " + entity.getId() + " ("+entity+")");
        } else {
            entity.updateProperties(data);
            DEBUG("Requirement updated: " + entity);
        }
        return entity;
    }
    ...
    public final void clearRequirementEstimationVotes() {
        DEBUG("Clearing RequirementEstimationVotes");
    ...
    protected scrum.client.estimation.RequirementEstimationVote updateRequirementEstimationVote(KunagiProperties data) {
        ...
        if (entity == null) {
            ...
            DEBUG("RequirementEstimationVote received: " + entity.getId() + " ("+entity+")");
        } else {
            entity.updateProperties(data);
            DEBUG("RequirementEstimationVote updated: " + entity);
        }
        return entity;
    }
    ...
    protected scrum.client.risks.Risk updateRisk(KunagiProperties data) {
        ...
        if (entity == null) {
            ...
            risks.put(id, entity);
            DEBUG("Risk received: " + entity.getId() + " ("+entity+")");
        } else {
            entity.updateProperties(data);
            DEBUG("Risk updated: " + entity);
        }
        return entity;
    }
    ...
    protected scrum.client.calendar.SimpleEvent updateSimpleEvent(KunagiProperties data) {
        ...
        if (entity == null) {
            ...
            DEBUG("SimpleEvent received: " + entity.getId() + " ("+entity+")");
        } else {
            entity.updateProperties(data);
            DEBUG("SimpleEvent updated: " + entity);
        }
        return entity;
    }
    ...
    protected scrum.client.sprint.Sprint updateSprint(KunagiProperties data) {
        ...
        if (entity == null) {
            ...
            DEBUG("Sprint received: " + entity.getId() + " ("+entity+")");
        } else {
            entity.updateProperties(data);
            DEBUG("Sprint updated: " + entity);
        }
        return entity;
    }
    ...
    protected scrum.client.sprint.SprintReport updateSprintReport(KunagiProperties data) {
        ...
        if (entity == null) {
            ...
            DEBUG("SprintReport received: " + entity.getId() + " ("+entity+")");
        } else {
            entity.updateProperties(data);
            DEBUG("SprintReport updated: " + entity);
        }
        return entity;
    }
    ...
    protected scrum.client.collaboration.Subject updateSubject(KunagiProperties data) {
        ...
        if (entity == null) {
            ...
            DEBUG("Subject received: " + entity.getId() + " ("+entity+")");
        } else {
            entity.updateProperties(data);
            DEBUG("Subject updated: " + entity);
        }
        return entity;
    }
    ...
    protected scrum.client.pr.Subscription updateSubscription(KunagiProperties data) {
        ...
        if (entity == null) {
            ...
            DEBUG("Subscription received: " + entity.getId() + " ("+entity+")");
        } else {
            entity.updateProperties(data);
            DEBUG("Subscription updated: " + entity);
        }
        return entity;
    }
    ...
    protected scrum.client.admin.SystemConfig updateSystemConfig(KunagiProperties data) {
        ...
        if (entity == null) {
            ...
            DEBUG("SystemConfig received: " + entity.getId() + " ("+entity+")");
        } else {
            entity.updateProperties(data);
            DEBUG("SystemConfig updated: " + entity);
        }
        return entity;
    }
    ...
    protected scrum.client.sprint.Task updateTask(KunagiProperties data) {
        ...
        if (entity == null) {
            ...
            tasks.put(id, entity);
            DEBUG("Task received: " + entity.getId() + " ("+entity+")");
        } else {
            entity.updateProperties(data);
            DEBUG("Task updated: " + entity);
        }
        return entity;
    }
    ...
    protected scrum.client.admin.User updateUser(KunagiProperties data) {
        ...
        if (entity == null) {
            ...
            users.put(id, entity);
            DEBUG("User received: " + entity.getId() + " ("+entity+")");
        } else {
            entity.updateProperties(data);
            DEBUG("User updated: " + entity);
        }
        return entity;
    }
    ...
    protected scrum.client.collaboration.Wikipage updateWikipage(KunagiProperties data) {
        ...
        if (entity == null) {
            ...
            DEBUG("Wikipage received: " + entity.getId() + " ("+entity+")");
        } else {
            entity.updateProperties(data);
            DEBUG("Wikipage updated: " + entity);
        }
        return entity;
    }
