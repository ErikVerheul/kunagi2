...
public interface ScrumServiceAsync {
    ...
    void changeProperties(int conversationNumber, String entityId, HashMap<String, Object> properties, com.google.gwt.user.client.rpc.AsyncCallback<scrum.client.DataTransferObject> callback);

    void createEntity(int conversationNumber, String type, HashMap<String, Object> properties, com.google.gwt.user.client.rpc.AsyncCallback<scrum.client.DataTransferObject> callback);
