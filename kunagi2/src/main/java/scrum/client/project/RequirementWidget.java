...
public class RequirementWidget extends AScrumWidget {
    ...
    private final boolean showTaskWork;
    private final boolean showComments;
    private final boolean planningPoker;
    private final boolean showChangeHistory;
    ...
    protected Widget onInitialization() {
        ...
        left.addFieldRow("Qualities", new AMultiSelectionViewEditWidget<Quality>() {
            ...
            protected void onViewerUpdate() {
                List<Quality> qualitys = new ArrayList<>(requirement.getQualitys());
            ...
            protected void onEditorUpdate() {
                List<Quality> qualitys = new ArrayList<>(requirement.getProject().getQualitys());
                Collections.sort(qualitys);
