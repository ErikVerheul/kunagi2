...
public class BurndownChart {
	...
	private static final Color COLOR_PAST_LINE = UtlExtend.parseHtmlColor(ScreenCssBuilder.cBurndownLine);
	private static final Color COLOR_PROJECTION_LINE = UtlExtend.parseHtmlColor(ScreenCssBuilder.cBurndownProjectionLine);
	private static final Color COLOR_OPTIMUM_LINE = UtlExtend.parseHtmlColor(ScreenCssBuilder.cBurndownOptimalLine);
	...
	public static void writeSprintBurndownChart(OutputStream out, List<? extends BurndownSnapshot> snapshots, Date firstDay,
	...
	private static JFreeChart createSprintBurndownChart(List<BurndownSnapshot> snapshots, Date firstDay, Date lastDay,
		...
		if (widthPerDay > 10) {
			...
			dateFormat = StrExtend.multiply(" ", (int) spaces) + dateFormat;
		}
