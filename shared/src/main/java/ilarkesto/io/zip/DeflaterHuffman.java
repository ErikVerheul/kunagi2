...
import static ilarkesto.io.zip.DeflaterConstants.DEFAULT_MEM_LEVEL;
...
class DeflaterHuffman {
        ...
        private static final int BUFSIZE = 1 << (DEFAULT_MEM_LEVEL + 6);
...
//  	  System.err.print("writeSymbol("+freqs.length+","+code+"): ");
                ...
                final void checkEmpty() {
                        ...
                        err.println("checkEmpty suceeded!");
                }
                ...
                private void buildLength(int childs[]) {
                        ...
                        if (DeflaterConstants.DEBUGGING) {
                                err.println("Tree " + freqs.length + " lengths:");
                                for (int i = 0; i < numLeafs; i++) {
                                        err.println("Node " + childs[2 * i] + " freq: " + freqs[childs[2 * i]]
	    ...
	    ;
                        ...
                        if (DeflaterConstants.DEBUGGING) {
                                err.println("*** After overflow elimination. ***");
                                for (int i = 0; i < numLeafs; i++) {
                                        err.println("Node " + childs[2 * i] + " freq: " + freqs[childs[2 * i]]
                                                + " len: " + length[childs[2 * i]]);
                                }
                ...
                void buildTree() {
                        ...
                        numCodes = max(maxCode + 1, minNumCodes);
                        ...
                        do {
                                ...
                                int mindepth = min(values[first] & 0xff, values[second] & 0xff);
